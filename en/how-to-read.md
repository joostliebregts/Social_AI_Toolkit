...
My expectation: as AI gets better at absorbing context, it will see patterns that we don't know. It will show us things about how we collaborate, what we need as groups, where our blind spots are.
...
**If you're new:** Start at [Why Social AI?](why.md) and follow the journey through the three phases. Each phase builds on the previous one.
...
**If you want to contribute:** This guide is in development. See the [Roadmap](ROADMAP.md) for what's coming and where there's room for input.
