...
**Baut auf:** [Transkription als Grundlage](../phase-1/transkription.md), als Rohmaterial für Mustererkennung

---

## Wann ist das relevant?

**Situation:** Du hast ein Gespräch facilitiert. Du spürst, dass etwas darin steckt (ein [wiederkehrendes Thema, eine unausgesprochene Spannung](../../phase-2-vertiefung.md), eine Dynamik, die du wahrnimmst), aber du kannst es nicht richtig in Worte fassen.

**Die Tendenz:** Dein Gefühl mit dir herumzutragen, aber ohne die Worte, um es konkret zu machen. Du weißt, dass etwas los ist; du kannst nur nicht darauf zeigen.

**Das Prinzip:** AI kann das Transkript nach Mustern durchsuchen, die du intuitiv spürst, aber nicht explizit machen kannst. Es ist eine Lupe, kein Ersatz für deine Wahrnehmung.

**Die Frage:** Was würde sich ändern, wenn du zeigen könntest, was du bisher nur fühlst?
...
| Phase | Die Atmosphäre | Dominante Emotion |
|-------|----------------|-------------------|
...
```prompt
# KONTEXT & ROLLE
Du fungierst als systemischer Stratege und Community-Builder.
Du hast Zugang zum Transkript eines Elternabends (~14 Teilnehmende).

# AUFGABE
Analysiere das Transkript und kartiere die emotionale Landschaft,
geordnet nach Schulphase (Kleinkinder/Frühe Grundschule vs. Mittlere Grundschule vs. Späte Grundschule).
...
**AI hat etwas Neues gefunden:**
Du wusstest nicht, dass es ein Muster gibt. AI zeigt es. Du denkst: "Oh, das hatte ich nicht gesehen."

**AI macht sichtbar, was du gefühlt hast:**
Du wusstest, dass etwas da war. AI gibt dem Worte. Du denkst: "Ja, genau das ist es."
...
```prompt
# ROLLE
Du bist ein Muster-Analyst, der hilft, implizite Gruppendynamiken
sichtbar zu machen.

# KONTEXT
Ich habe dieses Gespräch facilitiert und habe eine Intuition, dass sich
etwas im Verlauf verschiebt. Aber ich kann es nicht genau benennen.
...
Auch ohne Namen im Transkript lassen sich Aussagen oft auf Einzelpersonen zurückverfolgen. Die Versuchung besteht zu fragen: "Wer blockiert hier?" Warum ich das problematisch finde: Es schafft eine unsichere Dynamik. Menschen fühlen sich beobachtet statt gehört.
...
**Bestätigungsfehler**
Ich suche nach Bestätigung für das, was ich schon denke. AI findet die "Belege", die ich finden will.
...
**Zu viel Vertrauen in AI**
AI findet immer etwas. Nicht alles, was es findet, ist ein echtes Muster.
...
**Muster als Fakten präsentieren**
Der Unterschied zwischen "es scheint, als ob" und "die Analyse zeigt" ist in Worten klein, in der Wirkung groß.
...
**Andere Zugänge zur Vertiefung:**
- [Was noch darin steckte](was-noch-darin-steckte.md): gemeinsam mit AI nach Struktur, Ankerpunkten und treffenden Zitaten graben (das ist die reaktive Variante: du fühlst noch nicht genau, wonach du suchst)

---

← [Zurück: Vom Gespräch zum Plan](gespraech-zum-plan.md) | [Zurück zu Phase 2: Vertiefung](../../phase-2-vertiefung.md) | [Weiter: Was noch darin steckte →](was-noch-darin-steckte.md)

---

*"AI macht sichtbar, was intuitiv spürbar war, aber noch nicht schwarz auf weiß stand."*
