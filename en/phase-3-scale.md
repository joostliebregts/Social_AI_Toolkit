...
1. **First analyze separately:** each session or breakout on its own, with the same methodology and the same prompt
2. **Then synthesize:** lay the analyses side by side, look for patterns, bring together
...
→ *[Go deeper: Over time, following shifts](techniques/phase-3/patterns-over-time.md)*
...
AI finds similarities; it's getting better at this, but the difference between real connection and coincidental overlap still requires your judgment. Two people who both said "tired" aren't automatically allies.
...
**Analyzing separately vs. wanting speed**
It's tempting to give everything to AI at once. But separate analyses with the same prompt yield comparable results, and that's where the real insights are. Patience pays off.
...
← [Back to Phase 2: Deepening](phase-2-deepening.md) | [Back to the beginning](phase-1-start.md)

---

*This is work in progress, based on experiments with scaling up, sometimes successful, sometimes not. I share it because I believe the direction is right, even if the answers aren't finished yet. The deep dives are being developed further. Interested in doing this together? Get in touch.*
