# Eigenaarschap zien groeien

> *Kan AI zichtbaar maken dat mensen eigenaar worden van wat besproken is?*

**Fase:** [Fase 3: Schaal](../../fase-3-schaal.md)
**Bouwt voort op:** [Patronen over tijd](patronen-over-tijd.md), specifiek voor eigenaarschap

> **Een eerlijk woord vooraf.** Dit is cutting-edge terrein. De experimenten met eigenaarschapsanalyse over tijd zijn gaande, niet afgerond. Ik heb theorie, ik heb praktische ervaring uit pilots, en ik heb veelbelovende resultaten — maar dit is geen bewezen methode. Lees dit als een uitnodiging om mee te kijken, niet als een handleiding die alles oplost.

---

## Wanneer is dit relevant?

**De meta-vraag:** Als AI patronen kan herkennen in een gesprek, kan het dan ook patronen *over meerdere gesprekken* vergelijken? En kun je dan specifieke verschuivingen — zoals eigenaarschap — bijhouden over tijd?

Wat ik ontdekte: ja. Dit is waar analyses over tijd krachtig worden.

**Situatie:** Je werkt aan een traject waarin het wenselijk is dat mensen eigenaarschap nemen over een plan, een visie, een verandering. Succesvolle implementatie en duurzaam draagvlak worden mogelijk als mensen eigenaarschap voelen. Je wilt weten of dat daadwerkelijk gebeurt. Volgens mij is dit een van de lastigste vragen als je met groepen werkt, want iedereen zegt ja als je vraagt of ze zich eigenaar voelen.

**De neiging:** Vragen "voelen jullie je eigenaar?" levert zelden nuttige antwoorden op. En puur op gevoel afgaan mist onderbouwing.

**Het principe:** Eigenaarschap uit zich in taal en actie. Niet in wat mensen zeggen dat ze voelen, maar in hoe ze over iets praten. En of voorgestelde acties ook daadwerkelijk worden uitgevoerd. AI kan die taal analyseren over meerdere sessies en verschuivingen zichtbaar maken die je anders zou missen.

**Relatie tot [Patronen over tijd](patronen-over-tijd.md):** Die techniek is de methodiek: hoe je analyses over tijd consistent uitvoert. Deze pagina is een specifieke *toepassing* binnen die methodiek. We passen dezelfde aanpak toe, maar zoeken naar een patroon — eigenaarschap — en volgen dat gericht. De kracht zit in de combinatie: de methodiek zorgt voor vergelijkbare data, de focus zorgt voor diepte.

**De vraag:** Hoe weet je of mensen echt eigenaar worden — niet alleen zeggen dat ze het zijn?
...
**Het eigenaarschap-loopje:**
eigenaarschap --> mensen aangehaakt --> oplossing gedragen --> mensen kunnen blijven praten --> duurzame oplossing
...
- **Juni:** "Een oplossing zit het eigenaarschap altijd in de weg" — de groep ontdekte dat te snel naar oplossingen gaan het eigenaarschap doodt.
- **September:** "Succes = Kwaliteit Idee x Eigenaarschap" — de formule werd expliciet, de groep begon ermee te werken.
- **Oktober:** "Zeg niet 'we hebben hulp nodig', zeg 'wil je mij helpen?'" — de groep vertaalde het principe naar concrete taal.

De groep gaf zelf tegengas bij de "oplossingsreflex" — de neiging om direct in oplossingen te schieten. Dat is eigenaarschap over eigenaarschap.

**De vraag is niet:** Kun je eigenaarschap afdwingen?
**De vraag is:** Kun je het zichtbaar maken? En wat kun je er dan mee?

---

## Het verhaal: hoe de ownership heuristic ontstond

Ik werkte al jaren met groepen en voelde wanneer eigenaarschap groeide. Maar ik kon het niet benoemen. Het was tacit expertise — je weet het als je het ziet, maar je kunt het niet in een systeem gieten.
...
Dit is precies het mechanisme dat deze pagina beschrijft: AI maakt zichtbaar wat er al is. In dit geval maakte AI mijn eigen tacit expertise zichtbaar. De heuristic is niet door AI bedacht — het is een formalisering van wat ik al wist maar niet kon uitschrijven.

### Het experiment

Met die heuristic in de hand begon ik transcripten te analyseren. Dezelfde prompt, dezelfde methodiek, sessie na sessie. De analyse van de eerste sessie gaf een lage eigenaarschapsscore. Logisch — de groep was sceptisch, het proces moest nog beginnen. Maar om dat te begrijpen moet je weten wat ik aan het doen was: ik voerde hetzelfde prompt uit op elk transcript, om te zien of de scores over tijd zouden verschuiven. Die lage score was het startpunt van het experiment.
...
**Analyses over tijd kunnen eigenaarschapsgroei zichtbaar maken.** Dit is geen magie — het is patroonherkenning over meerdere datapunten. Maar het effect is krachtig: je kunt inspelen op groei die aan het ontstaan is.
...
**Sessie 1:** "Ik ga dat doen"
**Sessie 2:** "Ik heb dat gedaan"

Dat iemand erop terugkomt — dat is eigenaarschap in actie.
...
Stel: je vraagt in sessie 1 naar "betrokkenheid" en in sessie 3 naar "eigenaarschap". Zelfs als de groep is gegroeid, kun je het niet zien — je meet iets anders. De methodiek moet constant zijn om verschuiving te kunnen waarnemen.
...
```prompt
**Ownership pulse analyse:** Je krijgt transcripten van [X]
sessies over [Y periode]. Analyseer de evolutie van
eigenaarschap per sessie.

**Scoring (0-1):**

Score elke sessie op deze vier componenten:

1. **Persoonlijke investering** (0-0.25)
   - Spontane verbinding met eigen ervaring
   - "Dit raakt iets waar ik al lang mee loop"
   - Bereidheid om kwetsbaarheid te delen

2. **Initiatief en eigen regie** (0-0.25)
...
3. **Follow-through** (0-0.25)
   - Terugkomen op eerdere toezeggingen
   - "Vorige keer zei ik dat ik... dat heb ik gedaan"
   - Consistentie over sessies

4. **Community-momentum** (0-0.15)
   - Kruisverwijzingen naar anderen
   - "Zoals [naam] vorige keer zei..."
   - Initiatief dat initiatief inspireert

5. **Anti-signalen** (max -0.15)
   - "Omdat het moet van mijn organisatie"
   - Afwachtende houding
   - "Dat is niet mijn afdeling"
...
- **Vier componenten met gewichten** dwingt AI om op meerdere dimensies te scoren, niet alleen op "voelt dit als eigenaarschap?" — persoonlijke investering, initiatief en follow-through wegen even zwaar; community-momentum is een bonus
- **Anti-signalen als correctie** stelt de score naar beneden bij als mensen enthousiast klinken maar in plichtsmodus zitten — maximaal -0.15 zodat het nooit de hele score wegvaagt
...
- **Bands voor interpretatie** (none/low/medium/high) maakt scores vergelijkbaar over sessies — je kunt zeggen "we gingen van low naar medium" in plaats van abstracte getallen
- **Evolutie over tijd** dwingt AI om niet alleen te meten maar ook te analyseren wat de verschuiving veroorzaakte — dat is waar je iets mee kunt
...
**Analyse op persoonsniveau**
Het is technisch mogelijk om eigenaarschap per individu te analyseren. De vraag is of je het wilt.

*Mijn aanpak:* Ik analyseer op groepsniveau, niet op persoonsniveau. De ethische vraag is niet alleen of het kan, maar of we er bewust mee omgaan. Wat gebeurt er met de transcriptie? Wie ziet de analyse? Als je het wel doet: communiceer helder en vraag toestemming. Zie ook: [Intuitie zwart op wit](../fase-2/intuitie-zwart-op-wit.md) voor meer over deze spanning.

**Woorden voor waarheid aannemen**
"Ik sta erachter" kan sociaal wenselijk zijn zonder echt eigenaarschap. Mensen zeggen soms ja terwijl ze nee bedoelen.
...
**Faciliteren versus afdwingen**
Als mensen geen eigenaarschap "nemen", is de verleiding om harder te pushen. Maar echte eigenaarschap ontstaat niet onder druk.
...
**Meten als doel**
Zo gefocust op het meten van eigenaarschap dat je het ontstaan ervan blokkeert.
...
**Wat AI leest versus wat mensen voelen**
AI kan vooralsnog alleen lezen wat er *gezegd* is. Het mensenwerk is om lichaamstaal en energie te voelen. Dit is geen beperking maar een taakverdeling: AI analyseert de woorden, mensen voelen de ruimte.

*Wat ik merk:* De rijkste analyses ontstaan als ik beide combineer. AI laat me zien dat iemand verschuift van "zij moeten" naar "wij gaan". Maar of die verschuiving ook voelbaar is in de groep — dat zie ik zelf, in hoe iemand rechtop gaat zitten, of hoe anderen reageren. De transcriptie is de grondstof. De mens voelt wat er niet in staat.
...
Dit hoeft niet groter te zijn dan vijftien minuten werk. Het gaat niet om de perfecte analyse — het gaat om de herkenning: klopt wat AI ziet met wat jij voelde?
...
Simon Sinek beschrijft vier gelukshormonen: endorfine, dopamine, serotonine en oxytocine. De laatste twee zijn sociaal gebonden — we voelen ons goed als we iets doen voor iemand anders, als iemand ons positieve feedback geeft. "Wauw, ik ben nuttig." En als we een belofte niet nakomen, voelen we schaamte: "ik heb iemand teleurgesteld."

De groepssetting is dus niet incidenteel. Het is wezenlijk. Eigenaarschap dat alleen in je hoofd zit, is anders dan eigenaarschap dat je uitgesproken hebt waar anderen bij waren. De biologie ondersteunt wat we intuïtief weten: commitment in een groep weegt zwaarder dan commitment voor jezelf.
...
- [Patronen over tijd](patronen-over-tijd.md) — de bredere analyse over tijd
- [Taal als eigenaarschap](../fase-1/taal-behouden.md) — waarom taal ertoe doet
- [Energie en consensus meten](energie-consensus.md) — een ander patroon om te volgen

---

← [Vorige: Haakjes vinden](haakjes-vinden.md) | [Terug naar Fase 3: Schaal](../../fase-3-schaal.md)

---

*"Eigenaarschap uit zich in taal. Van 'er moet iets gebeuren' naar 'ik ga dat doen' — dat is de verschuiving die ertoe doet."*
